...
export function SlidesInputStage() {
  ...
  const addSlidePrompts = useCarouselStore((s) => s.addSlidePrompts)
  ...
  const handleGenerate = () => {
    ...
    void addSlidePrompts(promptLines)
  }
      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex items-start justify-between mb-10">
          <div>
            ...
            <h1 className="mt-3 text-2xl font-semibold tracking-tight">Add slide prompts</h1>
